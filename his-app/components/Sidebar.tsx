...
import { Users, Activity, FileText, Settings, HeartPulse, Hospital } from 'lucide-react';
  ...
  return (
    <div className="flex h-full w-64 flex-col border-r border-[var(--border)] bg-[var(--sidebar-bg)] shadow-sm">
      <div className="flex h-16 items-center gap-2 border-b border-[var(--border)] px-6">
        ...
        <span className="text-xl font-bold text-[var(--foreground)]">Hospital one+</span>
      </div>
      ...
      <div className="border-t border-[var(--border)] p-4">
        <div className="flex items-center gap-3">
          ...
          <div className="flex flex-col">
            <span className="text-sm font-medium text-[var(--foreground)]">Dr.agasa</span>
            <span className="text-xs text-[var(--sidebar-fg)]">agasa.conan@hotspot.com</span>
          </div>
        </div>
      </div>
    </div>
